...
namespace SurveyEF.Migrations
{
    ...
    [Migration("20230911152540_OptionsToJsonUpdate")]
    partial class OptionsToJsonUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SurveyEF.Entities.RankingQuestion", b =>
                {
                    ...
                    b.ToTable("Questions", t =>
                        {
                            t.Property("OptionsJson")
                                .HasColumnName("RankingQuestion_OptionsJson");
                        });
            ...
            modelBuilder.Entity("SurveyEF.Entities.LikertScaleAnswerEntity", b =>
                {
                    ...
                    b.ToTable("UserAnswers", t =>
                        {
                            t.Property("Answer")
                                .HasColumnName("LikertScaleAnswerEntity_Answer");
                        });

                    b.HasDiscriminator().HasValue("LikerScale");
                });

            modelBuilder.Entity("SurveyEF.Entities.MultipleChoiceAnswerEntity", b =>
                {
                    b.HasBaseType("SurveyEF.Entities.UserAnswerEntity");
                    ...
                    b.ToTable("UserAnswers", t =>
                        {
                            t.Property("Answer")
                                .HasColumnName("MultipleChoiceAnswerEntity_Answer");
                        });
