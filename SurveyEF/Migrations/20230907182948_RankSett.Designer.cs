...
namespace SurveyEF.Migrations
{
    ...
    [Migration("20230907182948_RankSett")]
    partial class RankSett
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RankingAnswerEntityRankingOptionEntity", b =>
                {
                    b.Property<int>("AnswersAnswerId")
                        .HasColumnType("int");

                    b.Property<int>("RankingOptionEntityRankOptionId")
                        .HasColumnType("int");

                    b.HasKey("AnswersAnswerId", "RankingOptionEntityRankOptionId");

                    b.HasIndex("RankingOptionEntityRankOptionId");

                    b.ToTable("RankingAnswerEntityRankingOptionEntity");
                });
            ...
            modelBuilder.Entity("SurveyEF.Entities.RankingOptionEntity", b =>
                {
                    b.Property<int>("RankOptionId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("RankOptionId");

                    b.HasIndex("RankOptionId", "QuestionId")
                        .IsUnique();

                    b.ToTable("RankingOptionEntity");
                });
            ...
            modelBuilder.Entity("RankingAnswerEntityRankingOptionEntity", b =>
                {
                    b.HasOne("SurveyEF.Entities.RankingAnswerEntity", null)
                        .WithMany()
                        .HasForeignKey("AnswersAnswerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SurveyEF.Entities.RankingOptionEntity", null)
                        .WithMany()
                        .HasForeignKey("RankingOptionEntityRankOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SurveyEF.Entities.RankingOptionEntity", b =>
                {
                    b.HasOne("SurveyEF.Entities.RankingQuestion", "Question")
                        .WithMany("Options")
                        .HasForeignKey("RankOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
